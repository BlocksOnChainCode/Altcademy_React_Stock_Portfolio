...
var Portfolio = function (_React$Component) {
  ...
  _createClass(Portfolio, [{
    ...
    value: function render() {
      ...
      var portfolioMarketValue = portfolio.reduce(function (sum, stock) {
        return stock.shares_owned * stock.market_price + sum;
      }, 0);
      var portfolioCost = portfolio.reduce(function (sum, stock) {
        return stock.shares_owned * stock.cost_per_share + sum;
      }, 0);
      var portfolioUnrealizedGainLoss = portfolioMarketValue - portfolioCost;
