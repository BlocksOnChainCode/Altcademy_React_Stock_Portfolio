...
class Portfolio extends React.Component {
  ...
  render() {
    ...
    const { form } = this.state;
    const portfolioMarketValue = portfolio.reduce((sum, stock) => stock.shares_owned * stock.market_price + sum, 0);
    const portfolioCost = portfolio.reduce((sum, stock) => stock.shares_owned * stock.cost_per_share + sum, 0);
    const portfolioUnrealizedGainLoss = portfolioMarketValue - portfolioCost;
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="col-12 col-md-6">
              <h4 className="mb-3">Portfolio value: $ {portfolioMarketValue}</h4>
            </div>
            <div className="col-12 col-md-6">
              <h4 className="mb-3">Portfolio gain/loss: $ {portfolioUnrealizedGainLoss}</h4>
            </div>
          </div>
        </div>
    );
